...
DATABASES = {
    'default': {
        ...
        'NAME': 'touroperator_db',                      # Or path to database file if using sqlite3.
...
AUTH_PROFILE_MODULE = 'operators.operator'
...
SECRET_KEY = '@%9x@u3od@f-i6g5t2q#f)wmqj6hl0*4&amp;_(d7b_y(f_#3j$^3u'
